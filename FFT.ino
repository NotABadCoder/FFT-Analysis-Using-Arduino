//Example data:
int data[64]={
  2000,2000,-10,-10,2000,2000,-10,-10,
  2000,2000,-10,-10,2000,2000,-10,-10,
  2000,2000,-10,-10,2000,2000,-10,-10,
  2000,2000,-10,-10,2000,2000,-10,-10,
  2000,2000,-10,-10,2000,2000,-10,-10,
...
float f_peaks[5],amp[5]; // top 5 frequencies peaks in descending order
//---------------------------------------------------------------------------//
...
void loop() {
  for(int i=0;i<64;i++){
    data[i]=analogRead(INPUT_PIN);
    delayMicroseconds(500);
  }
  delay(10000);

//example
FFT(data,64,2000);        //to get top five value of frequencies of signal and their having 64 sample at 2000Hz sampling
...
For higher Number of sample may arise Memory related issue,
Code by ABHILASH
...
a=N;  
      ...
      for(int i=0;i<12;i++)                 //calculating the levels
         { if(data[i]<=a){o=i;} }
        //  for(int i=0;i<12;i++)                 //calculating the levels
        //  { if(data[i]<=a){N=data[i];}
        //     else break;
        //   }
      
int* in_ps = new int[data[o]]{};
float* out_r = new float[data[o]]{};
float* out_im = new float[data[o]]{};
